...
import { createMenssage } from "../utils";
const Contact = () => {
  return (
    <div className="container">
      <div className={styles.container_contact}>
        <div className={styles.detail}>
          <h2 className={styles.title}>Contactar con nosotros</h2>
          <div className={styles.contact}>
            ...
            <span className={styles.name}>+59 5985856072</span>
          </div>
          <div className={styles.contact}>
            <span className={styles.icon}>
              <svg
            ...
            <span className={styles.name}>support@ehupi.com</span>
          </div>
          <div className={styles.contact}>
            <span className={styles.icon}>
              <svg
  ...
  return (
    <div className={styles.container_form}>
      <form className={styles.form}>
        <h2 className={styles.title1}>¡Enviar un mensaje!</h2>
        <input 
          type="email" 
        ...
        <input 
          type="email" 
          placeholder="Correo: example@ehupi.com" 
        ...
        <button
          ...
          onClick={() => {
            const ToPhone = "51990354692";
            const Message_format = createMenssage({ user, email, message });
            window.open(
